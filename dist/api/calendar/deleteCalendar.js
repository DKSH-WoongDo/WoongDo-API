...
router.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { calendarID } = Object.assign(req.body, req.query);
    if (!calendarID) {
        return res.json({
            isError: true,
    ...
    try {
        ...
        const query2 = yield (0, dbHandle_1.sql)(`DELETE FROM ${process.env.MYSQL_DB}.calendar WHERE calendarID=? AND userID=?`, [calendarID, cryptoHandle_1.cryptoHandle.AES_DEC(returnValue.id)]);
